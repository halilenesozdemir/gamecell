  ...
  return (
    <>
      <div className='container-fluid py-3'>
        <div className='row d-flex flex-col justify-content-center align-items-center px-3 py-3 bg-black'>
          <div className='col col-lg-5 col-sm-8'>
              ...
              {({ values, errors, handleChange, handleSubmit, handleReset, dirty, isSubmitting, touched }) => (
                <form onSubmit={handleSubmit}>
                  ...
                  <button
                    ...
                    className='btn btn-lg d-block mx-auto bg-secondary bg-opacity-100 w-100 rounded-0 text-white m-3'>
                    SUBMIT
                  </button>
                </form>
              )}
            ...
            <div className='text-center text-muted d-flex'>
              <p className='m-0 register-login-text'>
                Daha önceden kayıt olduysan hemen <span className='text-decoration-underline'>Oturum aç!</span>
              </p>
            </div>
          </div>
          <div className='d-none d-lg-block col-md-8 col-lg-7   '>
